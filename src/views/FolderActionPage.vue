<template>
    <v-container class="pa-5 folders_inner_block" fluid>
        <div class="bg-white mb-4 border-1">
        ...
        <v-row>
            <v-col cols="6">
                Папки
                <div v-for="child in childs" :key="child._id" class="bg-white">
                    <v-list-item class="border-1" link @click="push(child._id)">
                        <v-list-item-icon
            ...
            <v-col cols="6"
                >Файлы
                <div v-for="f in files" :key="f._id" class="border-1">
        ...
        getFolder() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    axios
                        .get("File/folder/" + this.$route.params.id)
                        .then((response) => {
